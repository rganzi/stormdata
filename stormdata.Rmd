---
title: "Measuring Harmful Weather Events"
...
### Geographic Distribution of Harm or Damage Done
```{r map.dmg()}
...
### Geographic Distribution of Weather Events
```{r map.evtype()}
